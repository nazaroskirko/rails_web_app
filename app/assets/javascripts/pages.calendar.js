...
(function($) {
    var PagesCalendar = function(element, options) {
        ...
        this.$html +='</div>'
        this.$html +='<div class="center-align col-md-6 col-md-offset-3"><h2>Practice Calendar</h2></div>'
        this.$html +='<div class="col-md-3"> <button class="btn m-t-10 pull-right new-appointment btn-primary hidden" data-target="#patientForm" data-toggle="modal"><i class="fa fa-plus"></i>Appointment</button> </div><div class="clearfix"></div>'
            ...
            */
            byDateRange: function(startDate,endDate){
                ...
                for (var i = 0; i < Calendar.settings.events.length; i++) {
                    console.log('calendar event:' +i + ":" + Calendar.settings.events[i].start)
        ...
        */
        ...
        wView.prototype._buildEventElement = function(h,arrayIndex,cellNo,eventStartHours, eventStartMins, eventEndHours, evenEndMins){
            ...
            var eventContent = "<div class='event-container " + Calendar.settings.events[arrayIndex].class+ " "+readonly+"' data-event-duration=" + moment(Calendar.settings.events[arrayIndex].end).diff(Calendar.settings.events[arrayIndex].start, 'minutes')  + " data-appid =" + Calendar.settings.events[arrayIndex].appid + " data-index=" + arrayIndex + " data-startTime=" + Calendar.settings.events[arrayIndex].start + " data-endTime=" + Calendar.settings.events[arrayIndex].end + " id=" + id + " data-id=" + id + " data-row=" + (parseInt(eventStartHours)) + " data-cell=" + cellNo + " style=" + h + ">"
        ...
        */
        ...
        MonthView.prototype.renderEvent = function(elem,arrayIndex,days) {
            ...
            var id = 'ca_' + moment(Calendar.settings.events[arrayIndex].start).unix() + arrayIndex;
            var readonly = (Calendar.settings.events[arrayIndex].readOnly == true) ? "readonly":"";
            var eventContent = "<div class='event-container " + Calendar.settings.events[arrayIndex].class + " "+readonly+"' "+width+" data-index=" + arrayIndex + " data-startTime=" + Calendar.settings.events[arrayIndex].start + " data-appid=" + Calendar.settings.events[arrayIndex].appid + " data-endTime=" + Calendar.settings.events[arrayIndex].end + " id=" + id + " data-id=" + id + ">"
            eventContent += "<div class='event-inner'>";
            eventContent += "<div class='event-title'>" + Calendar.settings.events[arrayIndex].title + "</div>";
            eventContent += "</div>"
            eventContent += "</div>"
        ...
        Calendar = {
            ...
            constructEventForUser: function(i) {
                ...
                var eventO = {
                    ...
                    appid: Calendar.settings.events[i].appid,
